...
\section{Análisis de isoeficiencia (condición de escalabilidad)}
...
\subsection{Función de overhead y forma canónica de la eficiencia}
...
\subsection{Isoeficiencia en MPI (memoria distribuida)}
...
\subsection{Isoeficiencia en OMP / PRAM (memoria compartida)}
...
\subsection{Comparación y elección del paradigma}
