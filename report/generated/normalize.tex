\section{Normalización de la complejidad teórica}\label{sec:normalizacion}
...
\subsection{Modelo con constantes físicas}
...
\subsection{Instanciación con los parámetros del experimento}
...
\subsection{Forma canónica y recuperación de constantes}
...
\subsection{Ajuste para la versión v2}\label{sec:norm-v2}
...
\subsection{Número óptimo de procesos para v2}
