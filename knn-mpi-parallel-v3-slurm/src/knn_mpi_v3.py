"""
KNN-MPI v3 Slurm-ready benchmark implementation.

This version preserves the clean v3 algorithm:
...
def main():
    parser = argparse.ArgumentParser(
        description="KNN-MPI v3: Scatterv + Bcast + Reduce(custom MergeTopK)"
    )
